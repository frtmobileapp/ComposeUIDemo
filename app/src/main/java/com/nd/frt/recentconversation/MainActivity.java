...
import static com.nd.frt.recentconversation.activity.DetailActivity.PARAM_USER_INDEX;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_add){
            ...
            userInfo.userName = "linlhp";
            userInfo.content = "429586155@qq.com";
            userInfo.avatarUrl = "https://randomuser.me/api/portraits/med/women/64.jpg";
